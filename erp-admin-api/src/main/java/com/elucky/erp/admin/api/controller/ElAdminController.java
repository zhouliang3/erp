...
@RestController
@RequestMapping("/el/admin")
@Validated
public class ElAdminController {
    @Autowired
    ...
    public Object info(String token) {
        ...
        ElAdmin admin = adminService.findById(adminId);
        if (admin == null) {
            return ResponseUtil.badArgumentValue();
        }
    ...
    public Object list(@LoginAdmin Integer adminId,
        ...
        List<ElAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
    ...
    private Object validate(ElAdmin admin) {
    ...
    @PostMapping("/create")
    public Object create(@LoginAdmin Integer adminId, @RequestBody ElAdmin admin) {
        if (adminId == null) {
            return ResponseUtil.unlogin();
        }
    ...
    public Object read(@LoginAdmin Integer adminId, @NotNull Integer id) {
        ...
        ElAdmin admin = adminService.findById(id);
        return ResponseUtil.ok(admin);
    }

    @PostMapping("/update")
    public Object update(@LoginAdmin Integer adminId, @RequestBody ElAdmin admin) {
        if (adminId == null) {
            return ResponseUtil.unlogin();
        }
        Object error = validate(admin);
    ...
    @PostMapping("/delete")
    public Object delete(@LoginAdmin Integer adminId, @RequestBody ElAdmin admin) {
        if (adminId == null) {
            return ResponseUtil.unlogin();
        }
